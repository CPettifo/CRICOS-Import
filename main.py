...
# It should have the following columns in this order: institution ID, institution name, whether credential is active (manually set this to "Yes" if it is not present in extraction)
